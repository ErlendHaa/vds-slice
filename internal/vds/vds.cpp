...
requestdata VDSHandle::request_volume_trace( const unique_ptr<float[][OpenVDS::Dimensionality_Max]> &coordinates,
                                             const std::size_t npoints,
                                             const InterpolationMethod interpolation_method ) {
...
requestdata VDSHandle::request_volume_subset( const VoxelBounds& voxel_bounds ) {
